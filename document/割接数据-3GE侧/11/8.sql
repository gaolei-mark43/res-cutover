...
select a.stock_id as DEPOT_ID,
       ...
       (select cc.channel_code
         ...
         where cc.channel_id = b.channel_id and cc.province_id in ('11')) as CHNL_CODE,
       ...
       (select me.eparchy_name
         ...
         where me.eparchy_code = a.eparchy_code and me.province_code in ('11')) as EPARCHYNAME,
       (select ma.area_name
          from td_m_area ma
...
select t.channel_code as DEPOT_ID,
       ...
       (select me.eparchy_name
          from td_m_eparchy me
         where me.eparchy_code = t.city_id and me.province_code in ('11')) as EPARCHYNAME,
       (select ma.area_name
          from td_m_area ma
...
select a.stock_id as DEPOT_ID,
 ...
 select c.depart_id from td_m_depart c where c.province_code in ('11'))
   and a.province_id = mp.province_code
   and a.province_id in ('11')
   and a.valid_flag = '1'
   and a.res_type_code = '1';
