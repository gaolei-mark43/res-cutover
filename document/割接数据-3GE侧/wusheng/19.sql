...
a.province_id || SEQ_res_detail_ID.Nextval TORD_ID,
 ...
 select /*+parallel(a,10)*/a.province_id || SEQ_res_detail_ID.Nextval TORD_ID, --_id
   ...
   where a.property_id = b.property_id
     ...
     and exists(select 1 from tf_r_tml_order tc where tc.relate_order_id=f.order_log_id and tc.order_bill_state in ('0','1','2','3','4') and tc.province_id in ('10','13','70','84','97'));
     commit;